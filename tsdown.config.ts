...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.JOOPO_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.JOOPO_BUILD_PRIVATE_QA === "1";
...
function shouldAlwaysBundleDependency(id: string): boolean {
  return id === "@joopo/fs-safe" || id.startsWith("@joopo/fs-safe/");
}
