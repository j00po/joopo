...
function makeTempDir() {
  return makeTrackedTempDir("joopo-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat joopo.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "joopo.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
