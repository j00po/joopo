...
describe("normalizePluginsConfig", () => {
  ...
  it("normalizes unknown plugin ids without loading discovery", async () => {
    ...
    const discoverPlugins = vi.spyOn(discovery, "discoverJoopoPlugins");
  ...
  it("does not load discovery or manifests for alias lookup", async () => {
    ...
    const discoverPlugins = vi.spyOn(discovery, "discoverJoopoPlugins").mockReturnValue({
      candidates: [
        {
          idHint: "anthropic",
          source: "/tmp/joopo-bundled-anthropic/index.js",
          rootDir: "/tmp/joopo-bundled-anthropic",
          origin: "bundled",
          bundledManifest: {
            id: "anthropic",
            configSchema: {},
        ...
        },
        {
          ...
          source: "/tmp/joopo-global-anthropic/index.js",
          rootDir: "/tmp/joopo-global-anthropic",
          origin: "global",
        },
      ],
      diagnostics: [],
    ...
    const loadManifest = vi.spyOn(manifest, "loadPluginManifest").mockReturnValue({
      ok: true,
      manifestPath: "/tmp/joopo-global-anthropic/joopo.plugin.json",
      manifest: {
