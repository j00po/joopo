...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverJoopoPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverJoopoPlugins: mocks.discoverJoopoPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    manifestPath: `/tmp/${overrides.id}/joopo.plugin.json`,
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/joopo.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverJoopoPlugins.mockReset();
    mocks.discoverJoopoPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
