...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: JoopoConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: JoopoConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: JoopoConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: JoopoConfig) => JoopoConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => JoopoConfig | Promise<JoopoConfig>;
