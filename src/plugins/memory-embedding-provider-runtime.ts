...
function readConfiguredProviderApiId(providerId: string, cfg?: JoopoConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: JoopoConfig): string[] {
  const ids = [id];
