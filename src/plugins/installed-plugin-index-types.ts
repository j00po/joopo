...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Joopo from plugin manifests, install records, and config policy. Use `joopo plugins registry --refresh`, `joopo plugins install/update/uninstall`, or `joopo plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored joopo.install metadata. This describes catalog/package
