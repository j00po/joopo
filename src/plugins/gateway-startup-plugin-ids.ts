...
function listPotentialEnabledChannelIds(config: JoopoConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: JoopoConfig): Set<string> {
