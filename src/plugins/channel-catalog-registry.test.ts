...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/joopo-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/joopo-weixin@2.3.7",
    installPath:
      "/tmp/joopo-test-home/.joopo/npm/node_modules/@tencent-weixin/joopo-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverJoopoPlugins: discoverSpy }));
