...
import { relinkJoopoPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: JoopoConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: JoopoConfig = {
    ...
    channels: channels as JoopoConfig["channels"],
  };
