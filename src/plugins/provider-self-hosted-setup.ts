...
export function applyProviderDefaultModel(cfg: JoopoConfig, modelRef: string): JoopoConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: JoopoConfig; modelId: string; modelRef: string; profileId: string } {
