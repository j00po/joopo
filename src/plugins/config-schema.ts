...
import type { JoopoPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: JoopoPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): JoopoPluginConfigSchema {
  return {
