...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.joopo.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.joopo.js").JoopoConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.joopo.js").JoopoConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.joopo.js").JoopoConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.joopo.js").JoopoConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.joopo.js").JoopoConfig,
