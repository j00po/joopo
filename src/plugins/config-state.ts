...
} & PluginActivationConfigSourceLike<JoopoConfig>;
...
const hasExplicitMemorySlot = (plugins?: JoopoConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: JoopoConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    Object.prototype.hasOwnProperty.call(plugins.entries, defaultSlotIdForKey("memory")),
  );

export const hasExplicitPluginConfig = (plugins?: JoopoConfig["plugins"]) =>
