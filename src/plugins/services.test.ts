...
import type { JoopoPluginService, JoopoPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: JoopoPluginServiceContext) {
...
function expectServiceContexts(
  contexts: JoopoPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: JoopoPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: JoopoPluginServiceContext[] = [];
    ...
    const officialInstallContexts: JoopoPluginServiceContext[] = [];
    ...
    const untrustedContexts: JoopoPluginServiceContext[] = [];
    ...
    const spoofedContexts: JoopoPluginServiceContext[] = [];
