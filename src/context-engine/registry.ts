...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("joopo.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("joopo.contextEngineRegistryState");
