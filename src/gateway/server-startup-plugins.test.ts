...
const resolveJoopoPackageRootSync = vi.hoisted(() => vi.fn((_params: unknown) => "/package"));
...
vi.mock("../infra/joopo-root.js", () => ({
  resolveJoopoPackageRootSync: (params: unknown) => resolveJoopoPackageRootSync(params),
}));
...
describe("prepareGatewayPluginBootstrap startup plugins", () => {
  beforeEach(() => {
    ...
    resolveJoopoPackageRootSync.mockClear().mockReturnValue("/package");
