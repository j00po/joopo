...
type GatewayInstallAuthMode = NonNullable<NonNullable<JoopoConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: JoopoConfig): boolean {
