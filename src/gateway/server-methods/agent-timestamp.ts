 ...
 *
 * @see https://github.com/joopo/joopo/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an JoopoConfig.
 */
export function timestampOptsFromConfig(cfg: JoopoConfig): TimestampInjectionOptions {
  return {
