...
import type { ConfigValidationIssue, JoopoConfig } from "../../config/types.joopo.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: JoopoConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, getRuntimeConfig() and loadJoopoPlugins() (called inside
