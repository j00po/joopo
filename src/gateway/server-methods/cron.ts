...
function listConfiguredAnnounceChannelIds(cfg: JoopoConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: JoopoConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: JoopoConfig, jobCreate: CronJobCreate) {
