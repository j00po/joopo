...
export function hasAmbiguousGatewayAuthModeConfig(cfg: JoopoConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: JoopoConfig): void {
