...
import type {
  ...
  JoopoPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): JoopoPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: JoopoPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
