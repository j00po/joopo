        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __joopoPreauthBudgetClaimed?: boolean;
              __joopoPreauthBudgetKey?: string;
            }
          ).__joopoPreauthBudgetKey = preauthBudgetKey;
