/**
 * Hook system for Joopo agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("joopo.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("joopo.internalHooksEnabled");
