...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/joopo-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/joopo-agent/.joopo-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: JoopoConfig) => {
