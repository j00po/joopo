      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["joopo gateway run", "Run the gateway in the foreground."],
            ["joopo gateway status", "Show service status plus connectivity/capability."],
            ["joopo gateway discover", "Find local and wide-area gateway beacons."],
            ["joopo gateway stability", "Show recent stability diagnostics."],
            ["joopo gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.joopo.ai/cli/gateway")}\n`,
      ),
  );
