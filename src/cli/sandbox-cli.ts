...
const SANDBOX_EXAMPLES = {
  main: [
    ["joopo sandbox list", "List all sandbox containers."],
    ["joopo sandbox list --browser", "List only browser containers."],
    ["joopo sandbox recreate --all", "Recreate all containers."],
    ["joopo sandbox recreate --session main", "Recreate a specific session."],
    ["joopo sandbox recreate --agent mybot", "Recreate agent containers."],
    ["joopo sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["joopo sandbox list", "List all sandbox containers."],
    ["joopo sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["joopo sandbox recreate --all", "Recreate all containers."],
    ["joopo sandbox recreate --session main", "Recreate a specific session."],
    ["joopo sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["joopo sandbox recreate --browser --all", "Recreate only browser containers."],
    ["joopo sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["joopo sandbox explain", "Show effective sandbox config."],
    ["joopo sandbox explain --session agent:main:main", "Explain a specific session."],
    ["joopo sandbox explain --agent work", "Explain an agent sandbox."],
    ["joopo sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.joopo.ai/cli/sandbox")}\n`,
    )
    .action(() => {
