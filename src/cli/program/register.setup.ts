...
export function registerSetupCommand(program: Command) {
  program
    .command("setup")
    .description("Initialize the active Joopo config and agent workspace")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/setup", "docs.joopo.ai/cli/setup")}\n`,
    )
    .option(
      "--workspace <dir>",
      "Agent workspace directory (default: ~/.joopo/workspace; stored as agents.defaults.workspace)",
    )
