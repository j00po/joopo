    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["joopo", "Start Crestodian."],
          ["joopo crestodian", "Start Crestodian explicitly."],
          ['joopo crestodian -m "status"', "Run one status request."],
          [
            'joopo crestodian -m "set default model openai/gpt-5.2" --yes',
