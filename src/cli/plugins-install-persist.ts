...
function addInstalledPluginToAllowlist(cfg: JoopoConfig, pluginId: string): JoopoConfig {
...
function removeInstalledPluginFromDenylist(cfg: JoopoConfig, pluginId: string): JoopoConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `joopo plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
