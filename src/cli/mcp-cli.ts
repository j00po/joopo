...
import { serveJoopoChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Joopo MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Joopo channels over MCP stdio")
