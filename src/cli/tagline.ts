const DEFAULT_TAGLINE = "All your chats, one Joopo.";
...
const TAGLINES: string[] = [
  "Your terminal just grew superpowers—type something and let the bot handle the busywork.",
  ...
  "Boots up, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like fresh toast: simple, satisfying, effective.",
  ...
  "Built for humans who'd rather ship than fight their tools.",
  ...
  "Open source, opinionated defaults, friendly disposition.",
  ...
  "Half butler, half debugger, fully on your side.",
  ...
  "You had me at 'joopo gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.JOOPO_TAGLINE_INDEX;
