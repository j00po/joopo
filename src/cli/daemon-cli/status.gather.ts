...
function resolveSnapshotRuntimeConfig(snapshot: ConfigFileSnapshot | null): JoopoConfig | null {
...
function coerceStatusConfig(value: unknown): JoopoConfig {
