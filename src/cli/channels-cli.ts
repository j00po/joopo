    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["joopo channels list", "List configured channels and auth profiles."],
          ["joopo channels status --probe", "Run channel status checks and probes."],
          [
            "joopo channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["joopo channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.joopo.ai/cli/channels",
        )}\n`,
    );
