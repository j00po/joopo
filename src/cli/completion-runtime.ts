...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "JOOPO_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
function isCompletionProfileHeader(line: string): boolean {
  return line.trim() === "# Joopo Completion";
}
 ...
 * Returns true if profile has `source <(joopo completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "joopo") {
  const home = process.env.HOME || os.homedir();
  let profilePath = "";
  let sourceLine = "";
