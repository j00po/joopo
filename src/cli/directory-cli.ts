    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["joopo directory self --channel slack", "Show the connected account identity."],
          [
            'joopo directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["joopo directory groups list --channel discord", "List available groups/channels."],
          [
            "joopo directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.joopo.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
