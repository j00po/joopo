...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof JoopoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: JoopoConfig; env: NodeJS.ProcessEnv }): {
  cfg: JoopoConfig;
  changes: string[];
} {
