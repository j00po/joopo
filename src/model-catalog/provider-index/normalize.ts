...
import type {
  JoopoProviderIndex,
  JoopoProviderIndexPluginInstall,
  JoopoProviderIndexPlugin,
  JoopoProviderIndexProviderAuthChoice,
  JoopoProviderIndexProvider,
} from "./types.js";

const JOOPO_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): JoopoProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): JoopoProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): JoopoProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): JoopoProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): JoopoProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly JoopoProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is JoopoProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): JoopoProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeJoopoProviderIndex(value: unknown): JoopoProviderIndex | undefined {
  if (!isRecord(value) || value.version !== JOOPO_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, JoopoProviderIndexProvider> = {};
  ...
  return {
    version: JOOPO_PROVIDER_INDEX_VERSION,
