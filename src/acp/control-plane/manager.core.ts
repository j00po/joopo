...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: JoopoConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: JoopoConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: JoopoConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: JoopoConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: JoopoConfig }): Promise<void> {
