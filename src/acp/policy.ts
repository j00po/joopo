...
export function isAcpEnabledByPolicy(cfg: JoopoConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: JoopoConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: JoopoConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: JoopoConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: JoopoConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: JoopoConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: JoopoConfig, agentId: string): boolean {
