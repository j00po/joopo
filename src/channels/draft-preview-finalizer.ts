...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `joopo/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `joopo/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `joopo/plugin-sdk/channel-message`.
 */
