...
export type ChannelMessageSendTextContext<TConfig = JoopoConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = JoopoConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = JoopoConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendAttemptContext<TConfig = JoopoConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = JoopoConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = JoopoConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
