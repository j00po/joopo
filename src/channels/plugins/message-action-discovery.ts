...
export function listChannelMessageActions(cfg: JoopoConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: JoopoConfig): ChannelMessageCapability[] {
