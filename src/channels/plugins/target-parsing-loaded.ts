...
/** @deprecated Use `channelRouteTargetsMatchExact` from `joopo/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `joopo/plugin-sdk/channel-route`. */
