...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: JoopoConfig): string | undefined {
  ...
  function listAccountIds(cfg: JoopoConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: JoopoConfig): string {
