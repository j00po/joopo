...
export function resolveConfiguredMediaMaxBytes(cfg?: JoopoConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: JoopoConfig | undefined, kind: MediaKind) {
