...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "joopo-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "joopo-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "joopo-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "joopo-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "joopo-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "joopo-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "joopo-legacy-state");
    const configDir = path.join("/tmp", "joopo-current-config");
