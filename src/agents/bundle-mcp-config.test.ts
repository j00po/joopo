...
describe("loadMergedBundleMcpConfig", () => {
  it("lets Joopo mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps Joopo transports to downstream CLI types when requested", () => {
    expect(
