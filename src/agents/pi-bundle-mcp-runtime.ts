...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("joopo.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: JoopoConfig): number {
