...
export const DEFAULT_SANDBOX_IMAGE = "joopo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "joopo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "joopo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "joopo-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "joopo-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "joopo-sandbox-browser";
