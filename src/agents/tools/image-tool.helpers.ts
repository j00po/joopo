...
export function coerceImageModelConfig(cfg?: JoopoConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: JoopoConfig; ref: string }): string[] {
