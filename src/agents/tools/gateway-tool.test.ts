...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: joopo doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: joopo doctor --non-interactive");
