...
function hasExplicitMusicGenerationModelConfig(cfg?: JoopoConfig): boolean {
...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under Joopo-managed media storage and delivered automatically as attachments.",
