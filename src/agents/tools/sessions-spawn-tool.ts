...
// Keep the schema local to avoid a circular import through acp-spawn/joopo-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: JoopoConfig }) {
