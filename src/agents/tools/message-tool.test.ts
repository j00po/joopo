...
type CreateJoopoTools = typeof import("../joopo-tools.js").createJoopoTools;
...
let createJoopoTools: CreateJoopoTools;
...
const joopoToolsFactoryMocks = vi.hoisted(() => {
...
vi.mock("./agents-list-tool.js", () => ({
  createAgentsListTool: () => joopoToolsFactoryMocks.tool("agents"),
}));
vi.mock("./cron-tool.js", () => ({
  createCronTool: () => joopoToolsFactoryMocks.tool("cron"),
}));
vi.mock("./gateway-tool.js", () => ({
  createGatewayTool: () => joopoToolsFactoryMocks.tool("gateway"),
}));
vi.mock("./heartbeat-response-tool.js", () => ({
  createHeartbeatResponseTool: () => joopoToolsFactoryMocks.tool("heartbeat_response"),
}));
...
vi.mock("./nodes-tool.js", () => ({
  createNodesTool: () => joopoToolsFactoryMocks.tool("nodes"),
}));
vi.mock("./pdf-tool.js", () => ({
  createPdfTool: () => null,
}));
vi.mock("./session-status-tool.js", () => ({
  createSessionStatusTool: () => joopoToolsFactoryMocks.tool("session_status"),
}));
vi.mock("./sessions-history-tool.js", () => ({
  createSessionsHistoryTool: () => joopoToolsFactoryMocks.tool("sessions_history"),
}));
vi.mock("./sessions-list-tool.js", () => ({
  createSessionsListTool: () => joopoToolsFactoryMocks.tool("sessions_list"),
}));
vi.mock("./sessions-send-tool.js", () => ({
  createSessionsSendTool: () => joopoToolsFactoryMocks.tool("sessions_send"),
}));
vi.mock("./sessions-spawn-tool.js", () => ({
  createSessionsSpawnTool: () => joopoToolsFactoryMocks.tool("sessions_spawn"),
}));
vi.mock("./sessions-yield-tool.js", () => ({
  createSessionsYieldTool: () => joopoToolsFactoryMocks.tool("sessions_yield"),
}));
vi.mock("./subagents-tool.js", () => ({
  createSubagentsTool: () => joopoToolsFactoryMocks.tool("subagents"),
}));
vi.mock("./tts-tool.js", () => ({
  createTtsTool: () => joopoToolsFactoryMocks.tool("tts"),
}));
vi.mock("./update-plan-tool.js", () => ({
  createUpdatePlanTool: () => joopoToolsFactoryMocks.tool("update_plan"),
}));
vi.mock("./video-generate-tool.js", () => ({
  createVideoGenerateTool: () => null,
}));
vi.mock("./web-tools.js", () => ({
  createWebFetchTool: () => joopoToolsFactoryMocks.tool("web_fetch"),
  createWebSearchTool: () => joopoToolsFactoryMocks.tool("web_search"),
}));
...
beforeAll(async () => {
  ...
  ({ createJoopoTools } = await import("../joopo-tools.js"));
});
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createJoopoTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });

    const tool = createJoopoTools({
      agentSessionKey: "agent:main:slack:channel:c123:thread:111.222",
      config: {} as never,
      agentChannel: "slack",
      currentChannelId: "channel:C123",
