...
describe("isSilentOverflowProneModel", () => {
  ...
  // joopo#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // Joopo's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of joopo#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; Joopo's preemptive compaction continues to
