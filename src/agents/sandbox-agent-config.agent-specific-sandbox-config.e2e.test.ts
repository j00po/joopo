...
async function resolveContext(config: JoopoConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): JoopoConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
