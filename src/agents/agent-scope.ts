...
function findMutableAgentEntry(cfg: JoopoConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: JoopoConfig, agentId: string): string | undefined {
