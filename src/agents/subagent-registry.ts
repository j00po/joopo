...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.JOOPO_TEST_FAST === "1" ? 1_000 : 60_000;
...
function resolveSubagentWaitTimeoutMs(cfg: JoopoConfig, runTimeoutSeconds?: number) {
