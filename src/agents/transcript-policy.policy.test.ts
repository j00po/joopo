...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.JOOPO_BUNDLED_PLUGINS_DIR;
  delete env.JOOPO_SKIP_PROVIDERS;
  delete env.JOOPO_SKIP_CHANNELS;
  delete env.JOOPO_SKIP_CRON;
  delete env.JOOPO_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
