...
export function isConfigPathTruthy(config: JoopoConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["joopo-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: JoopoConfig): string[] | undefined {
