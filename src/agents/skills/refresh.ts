...
function resolveWatchPaths(workspaceDir: string, config?: JoopoConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: JoopoConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: JoopoConfig }) {
