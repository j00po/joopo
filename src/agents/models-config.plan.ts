...
type ModelsConfig = NonNullable<JoopoConfig["models"]>;
...
export async function planJoopoModelsJsonWithDeps(
  params: {
    cfg: JoopoConfig;
...
export async function planJoopoModelsJson(
  params: Parameters<typeof planJoopoModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planJoopoModelsJsonWithDeps(params);
}
