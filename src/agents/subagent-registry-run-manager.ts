...
const RECOVERABLE_WAIT_RETRY_DELAY_MS = process.env.JOOPO_TEST_FAST === "1" ? 25 : 5_000;
...
export function createSubagentRunManager(params: {
  ...
  resolveSubagentWaitTimeoutMs(cfg: JoopoConfig, runTimeoutSeconds?: number): number;
