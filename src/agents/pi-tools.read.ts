...
function resolveAdaptiveReadMaxBytes(options?: JoopoReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createJoopoReadTool(base, {
...
export function createJoopoReadTool(
  base: AnyAgentTool,
  options?: JoopoReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
