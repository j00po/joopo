...
function redactTranscriptText(value: string, cfg?: JoopoConfig): string {
...
function redactTranscriptContentBlock(block: unknown, cfg?: JoopoConfig): unknown {
...
function redactTranscriptContent(content: unknown, cfg?: JoopoConfig): unknown {
...
function redactTranscriptMessage(message: AgentMessage, cfg?: JoopoConfig): AgentMessage {
