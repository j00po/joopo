...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "joopo:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: JoopoConfig): AgentContextInjection {
