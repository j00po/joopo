...
export function resolveSubagentToolPolicy(cfg?: JoopoConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: JoopoConfig["tools"]): string[] | undefined {
