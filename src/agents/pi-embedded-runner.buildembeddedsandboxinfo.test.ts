...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/joopo-sandbox",
    agentWorkspaceDir: "/tmp/joopo-workspace",
    workspaceAccess: "none",
    runtimeId: "joopo-sbx-test",
    runtimeLabel: "joopo-sbx-test",
    containerName: "joopo-sbx-test",
    ...
    browser: {
      ...
      containerName: "joopo-sbx-browser-test",
    },
