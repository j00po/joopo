...
function isValidMiddlewareToolResult(value: unknown): value is JoopoAgentToolResult {
...
function buildMiddlewareFailureResult(): JoopoAgentToolResult {
  return {
    content: [
      {
        type: "text",
