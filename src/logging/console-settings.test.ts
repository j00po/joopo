...
let originalJoopoTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalJoopoTestConsole = process.env.JOOPO_TEST_CONSOLE;
  process.env.JOOPO_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalJoopoTestConsole === undefined) {
    delete process.env.JOOPO_TEST_CONSOLE;
  } else {
    process.env.JOOPO_TEST_CONSOLE = originalJoopoTestConsole;
  }
