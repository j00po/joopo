...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __joopoDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__joopoDiagnosticStabilityState ??= createState();
  return globalStore.__joopoDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__joopoDiagnosticStabilityState = next;
}
