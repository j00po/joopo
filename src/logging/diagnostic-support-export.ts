...
const SUPPORT_EXPORT_PREFIX = "joopo-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$JOOPO_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/joopo-sanitized.jsonl`: sanitized log summaries and metadata",
