...
describe("runCommandWithTimeout", () => {
  ...
  it("merges custom env with base env and drops undefined values", () => {
    ...
    expect(resolved.JOOPO_BASE_ENV).toBe("base");
    expect(resolved.JOOPO_TEST_ENV).toBe("ok");
    expect(resolved.JOOPO_TO_REMOVE).toBeUndefined();
    expect(resolved.JOOPO_CLI).toBe(JOOPO_CLI_ENV_VALUE);
  });
