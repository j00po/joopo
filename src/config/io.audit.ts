...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.JOOPO_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.JOOPO_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.JOOPO_WATCH_COMMAND),
