...
let runtimeConfigSnapshot: JoopoConfig | null = null;
let runtimeConfigSourceSnapshot: JoopoConfig | null = null;
...
function configSnapshotsMatch(left: JoopoConfig, right: JoopoConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: JoopoConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): JoopoConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: JoopoConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  ...
  runtimeConfig?: JoopoConfig | null;
  runtimeSourceConfig?: JoopoConfig | null;
...
export function loadPinnedRuntimeConfig(loadFresh: () => JoopoConfig): JoopoConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: JoopoConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => JoopoConfig;
