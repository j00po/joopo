...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): JoopoConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: JoopoConfig, env: NodeJS.ProcessEnv) =>
