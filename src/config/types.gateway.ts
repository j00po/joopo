...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "joopo.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/joopo"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__joopo__/canvas or /__joopo__/a2ui content.
   */
 ...
 * Used when Joopobot runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/joopo/joopo/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var JOOPO_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
