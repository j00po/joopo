...
export type JoopoConfig = {
  $schema?: string;
  meta?: {
    /** Last Joopo version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Joopo UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const joopoConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = JoopoConfig & {
  readonly [joopoConfigStateBrand]?: TState;
};
