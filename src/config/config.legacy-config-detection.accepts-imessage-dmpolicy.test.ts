...
function expectJoopoSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = JoopoSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectJoopoSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = JoopoSchema.safeParse(config);
