      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/joopo.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/joopo.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/joopo.plugin.json",
  ...
  it("rejects installable provider ids when the plugin is not active", () => {
    ...
    expect(res.issues).toContainEqual(
      expect.objectContaining({
        ...
        message:
          'web_search provider is not available: brave (install or enable plugin "brave", then run joopo doctor --fix)',
