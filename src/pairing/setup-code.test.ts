...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("JOOPO_GATEWAY_TOKEN", "");
    vi.stubEnv("JOOPO_GATEWAY_PASSWORD", "");
    vi.stubEnv("JOOPO_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses JOOPO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
