...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: JoopoConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: JoopoConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: JoopoConfig }>,
