...
export function listBindings(cfg: JoopoConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: JoopoConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: JoopoConfig) {
