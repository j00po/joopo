...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: JoopoConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: JoopoConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: JoopoConfig;
  agentDir?: string;
  listProviders: (cfg?: JoopoConfig) => CapabilityProviderCandidate[];
}): string[] {
