...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: JoopoConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: JoopoConfig, deps?: BrowserDoctorDeps) {
  try {
