...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `joopo doctor --fix`.";
    case "module-missing":
      return "Fix: run `joopo doctor --fix`.";
    case "service-missing":
      return "Fix: run `joopo gateway install --force`.";
    case "service-stopped":
      return "Fix: run `joopo gateway restart`.";
    case "startup-blocked":
      return "Fix: run `joopo gateway status --deep`.";
    case "not-listening":
      return "Fix: start `joopo gateway run`, or run `joopo gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
