...
function resolveConfiguredCommandOwners(cfg: JoopoConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: JoopoConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: JoopoConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("joopo config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
