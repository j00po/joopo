...
export function collectMissingDefaultAccountBindingWarnings(cfg: JoopoConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: JoopoConfig): string[] {
  const warnings: string[] = [];
