...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "JOOPO_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "JOOPO_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<JoopoConfig> | JoopoConfig;
  };
...
function listConfiguredChannelIds(config: JoopoConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: JoopoConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as JoopoConfig;
