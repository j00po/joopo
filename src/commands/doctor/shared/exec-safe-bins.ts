...
function collectExecSafeBinScopes(cfg: JoopoConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: JoopoConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: JoopoConfig): {
  config: JoopoConfig;
  changes: string[];
  warnings: string[];
} {
