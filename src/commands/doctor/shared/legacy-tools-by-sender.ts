...
export function scanLegacyToolsBySenderKeys(cfg: JoopoConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: JoopoConfig): {
  config: JoopoConfig;
  changes: string[];
} {
