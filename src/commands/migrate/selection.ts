...
export const MIGRATION_SKILL_SELECTION_TOGGLE_ALL_ON = "__joopo_migrate_toggle_all_on__";
export const MIGRATION_SKILL_SELECTION_TOGGLE_ALL_OFF = "__joopo_migrate_toggle_all_off__";
export const MIGRATION_SKILL_SELECTION_SKIP = "__joopo_migrate_skip_for_now__";
