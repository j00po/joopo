...
function noteFlowRecoveryHints() {
  ...
  note(
    [
      ...
      `Inspect: ${formatCliCommand("joopo tasks flow show <flow-id>")}`,
      `Cancel: ${formatCliCommand("joopo tasks flow cancel <flow-id>")}`,
    ]
...
export function noteWorkspaceStatus(cfg: JoopoConfig) {
