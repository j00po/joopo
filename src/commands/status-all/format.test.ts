...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://joopo.local")).toBe("https://joopo.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://joopo.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: joopo security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://joopo.local" },
      ...
      { Item: "Security", Value: "Run: joopo security audit --deep" },
