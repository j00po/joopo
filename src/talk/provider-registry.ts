...
function resolveRealtimeVoiceProviderEntries(cfg?: JoopoConfig): RealtimeVoiceProviderPlugin[] {
...
function buildProviderMaps(cfg?: JoopoConfig): {
...
export function listRealtimeVoiceProviders(cfg?: JoopoConfig): RealtimeVoiceProviderPlugin[] {
