...
function resolveResolutionLimits(config: JoopoConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: JoopoConfig): SecretProviderConfig {
