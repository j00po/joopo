...
function hasConfiguredPluginEntries(config: JoopoConfig): boolean {
...
function hasConfiguredChannelEntries(config: JoopoConfig): boolean {
...
function hasRuntimeWebToolConfigSurface(config: JoopoConfig): boolean {
