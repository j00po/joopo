...
function makeContext(sourceConfig: JoopoConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: JoopoConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: JoopoConfig): void {
