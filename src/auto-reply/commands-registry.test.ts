...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@joopo", { botUsername: "joopo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@joopo args", {
        botUsername: "joopo",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "joopo" })).toBe(
      "/help@otherbot",
    );
  });
