...
import {
  buildCurrentJoopoCliArgv,
  buildCurrentJoopoCliCommand,
} from "./commands-joopo-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.joopo.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentJoopoCliArgv(args),
    command: buildCurrentJoopoCliCommand(args),
    displayCommand: ["joopo", ...args].join(" "),
    encodedRequest,
    request,
  };
}
