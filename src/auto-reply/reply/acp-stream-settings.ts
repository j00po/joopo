...
function resolveAcpStreamCoalesceIdleMs(cfg: JoopoConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: JoopoConfig): number {
...
export function resolveAcpProjectionSettings(cfg: JoopoConfig): AcpProjectionSettings {
