...
type JoopoToolsRuntime = typeof import("../../agents/joopo-tools.runtime.js");
...
const joopoToolsRuntimeLoader = createLazyImportLoader<JoopoToolsRuntime>(
  () => import("../../agents/joopo-tools.runtime.js"),
);
...
function loadJoopoToolsRuntime(): Promise<JoopoToolsRuntime> {
  return joopoToolsRuntimeLoader.load();
}
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createJoopoTools } = await loadJoopoToolsRuntime();
