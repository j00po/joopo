...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as JoopoConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as JoopoConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
