...
function resolveMentionPatterns(cfg: JoopoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: JoopoConfig | undefined, agentId?: string): RegExp[] {
