...
const { buildStatusReplyMock, createJoopoToolsMock, getChannelPluginMock, handleCommandsMock } =
  vi.hoisted(() => ({
    buildStatusReplyMock: vi.fn(),
    createJoopoToolsMock: vi.fn(),
...
vi.mock("../../agents/joopo-tools.runtime.js", () => ({
  createJoopoTools: (...args: unknown[]) => createJoopoToolsMock(...args),
}));
