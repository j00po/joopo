...
describe("fs-safe defaults", () => {
  ...
  it("disables the Python helper by default in Joopo", async () => {
  ...
  it("honors the Joopo-specific env mode override", async () => {
    process.env.JOOPO_FS_SAFE_PYTHON_MODE = "auto";
