  ...
  return withEnvAsync(
    {
      ...
      JOOPO_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when JOOPO_VERSION is not set", async () => {
  ...
  it("prefers JOOPO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over JOOPO_SERVICE_VERSION when JOOPO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        JOOPO_VERSION: " ",
        JOOPO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when JOOPO_VERSION and JOOPO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        JOOPO_VERSION: " ",
        JOOPO_SERVICE_VERSION: "\t",
