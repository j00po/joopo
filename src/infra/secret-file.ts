...
import { readSecretFileSync as readSecretFileSyncImpl } from "@joopo/fs-safe/secret";
...
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@joopo/fs-safe/secret";
