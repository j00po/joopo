...
/**
 * @deprecated Compatibility facade for the `joopo/plugin-sdk/discord` subpath.
...
export type { JoopoConfig } from "./config-types.js";
export type { JoopoPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<JoopoConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: JoopoConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: JoopoConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: JoopoConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: JoopoConfig }): JoopoConfig {
...
export function listDiscordAccountIds(cfg: JoopoConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: JoopoConfig): string {
