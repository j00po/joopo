...
import type { ModelDefinitionConfig, JoopoConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: JoopoConfig) => JoopoConfig;
  applyLitellmProviderConfig: (cfg: JoopoConfig) => JoopoConfig;
