...
const JOOPO_SOURCE_EXTENSIONS_ROOT = path.resolve(JOOPO_PACKAGE_ROOT, "extensions");
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  const bundledLocation = resolveBundledFacadeModuleLocation({
    ...
    packageRoot: JOOPO_PACKAGE_ROOT,
    bundledPluginsDir,
  });
  if (bundledLocation) {
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: JOOPO_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
