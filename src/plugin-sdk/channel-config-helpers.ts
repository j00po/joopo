...
type ChannelConfigAccessorParams<Config extends JoopoConfig = JoopoConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends JoopoConfig = JoopoConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends JoopoConfig = JoopoConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: JoopoConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends JoopoConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends JoopoConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends JoopoConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
