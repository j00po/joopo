...
export { VERSION as JOOPO_VERSION } from "../version.js";
...
export { resolveJoopoAgentDir } from "./agent-dir-compat.js";
export {
  resolveAgentDir,
 ...
 * preserve the same Joopo-owned fallback signals as the built-in PI path
