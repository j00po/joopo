...
export function installJoopoOwnedToolHooks(params?: {
 ...
 * Pair with `installJoopoOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetJoopoOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
