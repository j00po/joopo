...
type LoginOpenAICodexOAuth =
  (typeof import("joopo/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("joopo/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type EnsureAuthProfileStore =
  typeof import("joopo/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("joopo/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("joopo/plugin-sdk/provider-auth-login", async () => {
      const actual = await vi.importActual<
        typeof import("joopo/plugin-sdk/provider-auth-login")
      >("joopo/plugin-sdk/provider-auth-login");
      return {
        ...actual,
    ...
    vi.doMock("joopo/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("joopo/plugin-sdk/provider-auth")>(
        "joopo/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
