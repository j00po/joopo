...
import type { JoopoPluginApi } from "../plugins/types.js";
...
export type { JoopoPluginToolContext, JoopoPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: JoopoConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
