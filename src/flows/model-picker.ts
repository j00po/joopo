...
export type PromptDefaultModelResult = { model?: string; config?: JoopoConfig };
...
function resolveConfiguredModelRaw(cfg: JoopoConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: JoopoConfig): string[] {
