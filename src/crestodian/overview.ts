...
type JoopoReferencePaths = Awaited<ReturnType<typeof resolveJoopoReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveJoopoReferencePaths?: typeof resolveJoopoReferencePaths;
};
...
function buildAgentSummaries(cfg: JoopoConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): JoopoReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveJoopoReferencePaths ?? resolveJoopoReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: JOOPO_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: JOOPO_SOURCE_URL,
    },
  };
}
