...
import { createSubsystemLogger, redactSensitiveText } from "./joopo-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "joopo:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Joopo-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/joopo/joopo/issues/63921
 */
