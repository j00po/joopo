import type { GatewayEvent, JsonObject, JoopoEvent, JoopoEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): JoopoEventType {
...
function normalizeAgentEventType(payload: JsonObject): JoopoEventType {
...
function normalizeNamedEventType(event: GatewayEvent): JoopoEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): JoopoEvent {
  const payload = asRecord(event.payload);
