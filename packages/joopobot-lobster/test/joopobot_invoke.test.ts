...
test("joopo.invoke posts to /tools/invoke and returns JSON", async () => {
  ...
  try {
    ...
    const cmd = registry.get("joopo.invoke");
...
test("joopo.invoke --each maps input items into tool args", async () => {
