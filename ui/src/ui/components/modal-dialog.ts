...
export class JoopoModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "joopo-modal-dialog-label" : "";
    const descriptionId = this.description ? "joopo-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("joopo-modal-dialog")) {
  customElements.define("joopo-modal-dialog", JoopoModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "joopo-modal-dialog": JoopoModalDialog;
  }
}
