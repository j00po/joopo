...
import { type JoopoModalDialog } from "./modal-dialog.ts";
...
describe("joopo-modal-dialog", () => {
  ...
  it("opens a labelled modal dialog with an optional description", async () => {
    ...
    expect(labelId).toBe("joopo-modal-dialog-label");
    expect(descriptionId).toBe("joopo-modal-dialog-description");
