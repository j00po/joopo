...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/joopo");
      expect(html).toContain('<a href="http://github.com/joopo"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Joopo中文](https://docs.joopo.ai)");
      expect(html).toContain('href="https://docs.joopo.ai"');
      expect(html).toContain("Joopo中文</a>");
    });
