...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[joopo] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
function hasTranscriptMeta(message: unknown): boolean {
  return Boolean(
    ...
    (message as { __joopo?: unknown }).__joopo &&
    typeof (message as { __joopo?: unknown }).__joopo === "object",
  );
}
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/joopo/joopo/issues/1909
