      ...
      renderToolCard(
        {
          ...
          outputText: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_counter",
              url: "/__joopo__/canvas/documents/cv_counter/index.html",
              title: "Counter demo",
  ...
  it("opens assistant-surface canvas payloads in the sidebar when explicitly requested", () => {
      ...
      renderToolCard(
        {
          ...
          outputText: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_sidebar",
              url: "/__joopo__/canvas/documents/cv_sidebar/index.html",
              title: "Player",
    ...
    expect(onOpenSidebar).toHaveBeenCalledWith(
      expect.objectContaining({
        kind: "canvas",
        docId: "cv_sidebar",
        entryUrl: "/__joopo__/canvas/documents/cv_sidebar/index.html",
      }),
    );
  });
});
