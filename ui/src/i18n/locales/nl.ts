...
export const nl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Op mobiel? Kopieer de volledige URL (inclusief #token=...) vanuit joopo dashboard --no-open op je desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — authenticeer opnieuw met joopo models auth",
