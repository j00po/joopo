...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.joopo/joopo.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde joopo dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con joopo models auth",
