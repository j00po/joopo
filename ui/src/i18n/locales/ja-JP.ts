...
export const ja_JP: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "モバイルを使用していますか？ デスクトップで joopo dashboard --no-open から完全な URL（#token=... を含む）をコピーしてください。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — joopo models auth で再認証してください",
