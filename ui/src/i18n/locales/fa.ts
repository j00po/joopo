...
export const fa: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "روی موبایل هستید؟ URL کامل (شامل #token=...) را از joopo dashboard --no-open روی دسکتاپ خود کپی کنید.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — با joopo models auth دوباره احراز هویت کنید",
