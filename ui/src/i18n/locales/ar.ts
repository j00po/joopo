...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من joopo dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام joopo models auth",
