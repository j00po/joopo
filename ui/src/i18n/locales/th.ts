...
export const th: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "ใช้งานบนมือถืออยู่หรือไม่? คัดลอก URL แบบเต็ม (รวม #token=...) จาก joopo dashboard --no-open บนเดสก์ท็อปของคุณ",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — ยืนยันตัวตนใหม่ด้วย joopo models auth",
