// Joopo Control – Service Worker
// Handles offline caching and push notifications.

const CACHE_NAME = "joopo-control-v1";
...
self.addEventListener("push", (event) => {
  ...
  try {
    ...
    data = { title: "Joopo", body: event.data.text() };
  }

  const title = data.title || "Joopo";
  const options = {
    body: data.body || "",
    icon: "./apple-touch-icon.png",
    badge: "./favicon-32.png",
    tag: data.tag || "joopo-notification",
    data: { url: data.url || "./" },
  };
