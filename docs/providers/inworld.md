---
summary: "Inworld streaming text-to-speech for Joopo replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Joopo it
...
Joopo posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Joopo synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Joopo asks Inworld for `OGG_OPUS` so the audio plays as a native
