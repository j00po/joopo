...
title: "Together AI"
read_when:
  - You want to use Together AI with Joopo
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    joopo onboard --auth-choice together-api-key
    ```
  </Step>
...
Joopo ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.joopo/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `joopo models list --provider together`
