---
summary: "Use NVIDIA's OpenAI-compatible API in Joopo"
read_when:
  - You want to use open models in Joopo for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    joopo onboard --auth-choice nvidia-api-key
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    joopo models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
...
```bash
joopo onboard --auth-choice nvidia-api-key --nvidia-api-key "nvapi-..."
```
