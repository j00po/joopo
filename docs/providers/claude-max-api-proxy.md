...
<Steps>
  ...
  <Step title="Configure Joopo">
    Point Joopo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Joopo
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Joopo integration with Claude CLI or API keys.
  </Card>
