---
summary: "Azure AI Speech text-to-speech for Joopo replies"
read_when:
...
Azure Speech is an Azure AI Speech text-to-speech provider. In Joopo it
...
Joopo uses the Azure Speech REST API directly with SSML and sends the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Joopo synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Joopo derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Joopo
