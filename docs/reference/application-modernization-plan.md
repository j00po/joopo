...
read_when:
  - Planning a broad Joopo application modernization pass
...
modernization task. If adopting this guidance as a repo-local Joopo skill,
create `.agents/skills/joopo-frontend/SKILL.md` first, keep the frontmatter
