...
`joopo/plugin-sdk/channel-message`. The adapter describes the native message
...
`joopo/plugin-sdk/channel-message-runtime` for monitor/send code paths that
...
```typescript
import { deriveDurableFinalDeliveryRequirements } from "joopo/plugin-sdk/channel-message";
...
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `joopo/plugin-sdk/channel-reply-pipeline` | `joopo/plugin-sdk/channel-message`                                                                               |
...
| `deliverDurableInboundReplyPayload(...)`     | `deliverInboundReplyWithMessageSendContext(...)` from `joopo/plugin-sdk/channel-message-runtime`                 |
