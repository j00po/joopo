---
summary: "Testing utilities and patterns for Joopo plugins"
...
Reference for test utilities, patterns, and lint enforcement for Joopo
plugins.
...
**Plugin API mock import:** `joopo/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `joopo/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `joopo/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `joopo/plugin-sdk/channel-test-helpers`

**Channel target test import:** `joopo/plugin-sdk/channel-target-testing`

**Plugin contract import:** `joopo/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `joopo/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `joopo/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `joopo/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `joopo/plugin-sdk/test-env`

**Generic fixture import:** `joopo/plugin-sdk/test-fixtures`

**Node builtin mock import:** `joopo/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`joopo/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "joopo/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "joopo/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "joopo/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "joopo/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "joopo/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "joopo/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "joopo/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "joopo/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "joopo/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "joopo/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "joopo/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "joopo/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "joopo/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Joopo inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "joopo/plugin-sdk/plugin-test-runtime";
```
...
Joopo's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `joopo/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `joopo/plugin-sdk` root barrel is rejected
...
Joopo uses Vitest with V8 coverage thresholds. For plugin tests:
