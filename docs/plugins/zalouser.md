...
read_when:
  - You want Zalo Personal (unofficial) support in Joopo
  - You are configuring or developing the zalouser plugin
title: "Zalo personal plugin"
---

Zalo Personal support for Joopo via a plugin, using native `zca-js` to automate a normal Zalo user account.
