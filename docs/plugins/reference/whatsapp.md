---
summary: "Adds the WhatsApp channel surface for sending and receiving Joopo messages."
read_when:
...
Adds the WhatsApp channel surface for sending and receiving Joopo messages.
