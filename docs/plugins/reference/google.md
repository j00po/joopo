---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to Joopo."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to Joopo.

## Distribution

- Package: `@joopo/google-plugin`
