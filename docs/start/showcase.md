...
<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @joopo on X](https://x.com/joopo).
</Info>
...
Joopo connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @joopo](https://x.com/joopo).
  </Step>
