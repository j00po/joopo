---
summary: "Overview of Joopo onboarding options and flows"
read_when:
...
Joopo has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `joopo onboard`                     | Launch the app            |
...
CLI command docs: [`joopo onboard`](/cli/onboard)

## macOS app onboarding

Open the Joopo app. The first-run wizard walks you through the same steps
