---
summary: "First-run setup flow for Joopo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Joopo">
...
<Step title="CLI">
  ...
  The app can install the global `joopo` CLI via npm, pnpm, or bun.
