...
Joopo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.joopo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["joopo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
