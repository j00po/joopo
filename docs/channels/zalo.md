...
Zalo ships as a bundled plugin in current Joopo releases, so normal packaged
...
- Install via CLI: `joopo plugins install @joopo/zalo`
- Pinned version: `joopo plugins install @joopo/zalo@2026.5.2`
- Or from a source checkout: `joopo plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Joopo behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `joopo pairing list zalo`
  - `joopo pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Joopo.
...
- Example: `joopo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `joopo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `joopo logs --follow`
