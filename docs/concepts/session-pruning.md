...
Joopo also builds a separate idempotent replay view for sessions that
...
Joopo auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Joopo does not override them.
