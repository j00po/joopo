...
`precise.yml` is Joopo's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Joopo paths are excluded by `.gitignore` for build reasons even though
