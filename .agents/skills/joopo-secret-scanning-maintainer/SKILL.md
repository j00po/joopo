---
name: joopo-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Joopo GitHub Secret Scanning alerts in issues or PRs.
---

# Joopo Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/joopo/joopo/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/joopo-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/joopo/joopo/issues/63101#issuecomment-xxx",
