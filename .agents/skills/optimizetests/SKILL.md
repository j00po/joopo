---
name: optimizetests
description: Optimize Joopo slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Joopo test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `JOOPO_VITEST_IMPORT_DURATIONS=1 JOOPO_VITEST_PRINT_IMPORT_BREAKDOWN=1`
