...
function registerCommands(): JoopoPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: JoopoPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: JoopoPluginCommandDefinition) => {
...
function findCommand(
  commands: JoopoPluginCommandDefinition[],
  name: string,
): JoopoPluginCommandDefinition {
