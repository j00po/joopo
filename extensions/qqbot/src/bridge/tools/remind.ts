import { callGatewayTool } from "joopo/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  JoopoPluginApi,
...
export function createRemindTool(
  toolContext: JoopoPluginToolContext = {},
...
export function registerRemindTool(api: JoopoPluginApi): void {
