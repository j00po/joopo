...
import { createLoggedPairingApprovalNotifier } from "joopo/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "joopo/plugin-sdk/channel-policy";
import {
...
import { buildPassiveProbedChannelStatusSummary } from "joopo/plugin-sdk/extension-shared";
import {
...
import { isPrivateNetworkOptInEnabled } from "joopo/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "Joopo: your access has been approved.",
