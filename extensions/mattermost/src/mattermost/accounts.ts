import { createAccountListHelpers } from "joopo/plugin-sdk/account-helpers";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "joopo/plugin-sdk/account-id";
import { resolveMergedAccountConfig } from "joopo/plugin-sdk/account-resolution";
import {
...
export function listMattermostAccountIds(cfg: JoopoConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: JoopoConfig): string {
