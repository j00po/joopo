import { createClaimableDedupe } from "joopo/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: JoopoConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<JoopoConfig["channels"]>["mattermost"]>;
