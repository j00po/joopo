...
import type { ChunkMode } from "joopo/plugin-sdk/reply-runtime";
import { describe, expect, it, vi } from "vitest";
import type { JoopoConfig, PluginRuntime } from "../../runtime-api.js";
...
describe("deliverMattermostReplyPayload", () => {
  it("suppresses payloads flagged as reasoning", async () => {
    ...
    const cfg = {} satisfies JoopoConfig;
  ...
  it("passes agent-scoped mediaLocalRoots when sending media paths", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "joopo-mm-state-"));
