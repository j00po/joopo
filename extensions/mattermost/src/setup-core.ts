...
import type { ChannelSetupAdapter } from "joopo/plugin-sdk/channel-setup";
...
import { createSetupInputPresenceValidator } from "joopo/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: JoopoConfig, accountId: string) {
