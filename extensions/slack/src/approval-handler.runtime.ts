...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "joopo/plugin-sdk/approval-reply-runtime";
...
import { logError, normalizeOptionalString } from "joopo/plugin-sdk/text-runtime";
import {
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<JoopoConfig["channels"]>["slack"]>["execApprovals"]
>;
