...
import { resolveDefaultAgentId } from "joopo/plugin-sdk/agent-runtime";
...
import type { DmPolicy, GroupPolicy } from "joopo/plugin-sdk/config-types";
import { createDedupeCache } from "joopo/plugin-sdk/dedupe-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("joopo/plugin-sdk/config-types").SlackSlashCommandConfig>;
  textLimit: number;
