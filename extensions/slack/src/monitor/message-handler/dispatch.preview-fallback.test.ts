...
vi.mock("joopo/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("joopo/plugin-sdk/channel-message", async (importOriginal) => {
  const actual = await importOriginal<typeof import("joopo/plugin-sdk/channel-message")>();
  return {
    ...actual,
...
vi.mock("joopo/plugin-sdk/channel-streaming", () => ({
...
vi.mock("joopo/plugin-sdk/outbound-runtime", () => ({
...
vi.mock("joopo/plugin-sdk/reply-payload", () => ({
...
vi.mock("joopo/plugin-sdk/text-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/joopo-store.json",
