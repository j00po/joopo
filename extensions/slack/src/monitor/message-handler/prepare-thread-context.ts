import { formatInboundEnvelope } from "joopo/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "joopo/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "joopo/plugin-sdk/config-types";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("joopo/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
