...
// Prefix for Joopo-generated action IDs to scope our handler
const JOOPO_ACTION_PREFIX = "joopo:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${JOOPO_ACTION_PREFIX}`);

  // Handle Joopo modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
