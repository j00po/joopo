...
vi.mock("joopo/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/channel-inbound")>(
    "joopo/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
