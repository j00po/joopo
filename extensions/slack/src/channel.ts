...
} from "joopo/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "joopo/plugin-sdk/channel-config-helpers";
import {
...
} from "joopo/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "joopo/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "joopo/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "joopo/plugin-sdk/outbound-send-deps";
import { buildOutboundBaseSessionKey, type RoutePeer } from "joopo/plugin-sdk/routing";
import {
...
//
// `joopo/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "joopo/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "joopo/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as JoopoConfig, toolContext as SlackActionContext | undefined),
    }),
