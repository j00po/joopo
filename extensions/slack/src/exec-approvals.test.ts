...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<JoopoConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<JoopoConfig["channels"]>["slack"]>>,
): JoopoConfig {
  return {
    channels: {
      slack: {
