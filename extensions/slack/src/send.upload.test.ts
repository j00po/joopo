...
vi.mock("joopo/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/fetch-runtime")>(
    "joopo/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
