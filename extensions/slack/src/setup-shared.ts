...
import { patchChannelConfigForAccount } from "joopo/plugin-sdk/setup-runtime";
import { formatDocsLink } from "joopo/plugin-sdk/setup-tools";
import type { ResolvedSlackAccount } from "./accounts.js";
import type { JoopoConfig } from "./channel-api.js";

export const SLACK_CHANNEL = "slack" as const;

export function buildSlackManifest(botName = "Joopo") {
  const safeName = botName.trim() || "Joopo";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Joopo`,
    },
    features: {
      bot_user: {
