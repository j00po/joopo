...
import { doesApprovalRequestMatchChannelAccount } from "joopo/plugin-sdk/approval-native-runtime";
import type { JoopoConfig } from "joopo/plugin-sdk/config-types";
import { normalizeStringifiedOptionalString } from "joopo/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: JoopoConfig): string[] {
