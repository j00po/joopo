...
import { resolveConfiguredCapabilityProvider } from "joopo/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "joopo/plugin-sdk/realtime-voice";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: JoopoConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as JoopoConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as JoopoConfig),
