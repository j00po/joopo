...
vi.mock("joopo/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/provider-http")>(
    "joopo/plugin-sdk/provider-http",
  );
  return {
    ...actual,
