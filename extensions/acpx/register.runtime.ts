...
import type { JoopoPluginService, JoopoPluginServiceContext } from "joopo/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: JoopoPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpxRuntimeLike | null;
  realService: JoopoPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpxRuntimeLike> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as JoopoPluginServiceContext);
