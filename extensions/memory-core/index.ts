...
import { resolveMemoryBackendConfig } from "joopo/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  config?: JoopoConfig;
  getConfig?: () => JoopoConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): JoopoConfig | undefined {
...
function resolveMemoryToolOptions(ctx: JoopoPluginToolContext): MemoryToolOptions {
