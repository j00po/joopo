...
import { createAsyncLock } from "joopo/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "joopo/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "joopo/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "joopo/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- joopo:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- joopo:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "joopo:dreaming:backfill-entry";
