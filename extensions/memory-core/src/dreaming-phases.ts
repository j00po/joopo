...
import {
  ...
  sessionPathForFile,
} from "joopo/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "joopo/plugin-sdk/memory-core-host-runtime-files";
import {
...
import type { JoopoPluginApi } from "joopo/plugin-sdk/plugin-entry";
import { appendRegularFile, privateFileStore } from "joopo/plugin-sdk/security-runtime";
...
type Logger = Pick<JoopoPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__joopo_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__joopo_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- joopo:dreaming:light:start -->",
    endMarker: "<!-- joopo:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- joopo:dreaming:rem:start -->",
    endMarker: "<!-- joopo:dreaming:rem:end -->",
  },
] as const;
