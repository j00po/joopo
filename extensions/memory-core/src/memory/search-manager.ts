...
import { checkQmdBinaryAvailability } from "joopo/plugin-sdk/memory-core-host-engine-qmd";
import {
...
import { normalizeAgentId } from "joopo/plugin-sdk/routing";

const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("joopo.memorySearchManagerCache");
type Maybe<T> = T | null;
