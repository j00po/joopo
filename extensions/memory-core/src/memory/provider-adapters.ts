...
import { resolveUserPath } from "joopo/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "joopo/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install ${NODE_LLAMA_CPP_RUNTIME_PACKAGE} next to the Joopo package or source checkout`
      : null,
