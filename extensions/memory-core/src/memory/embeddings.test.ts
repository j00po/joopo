...
import type { MemoryEmbeddingProviderAdapter } from "joopo/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("joopo/plugin-sdk/memory-core-host-engine-embeddings", () => ({
