...
class SessionDeltaHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as JoopoConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/joopo-test-workspace";
...
describe("session archive delta bypass", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "joopo-archive-delta-"));
  });
