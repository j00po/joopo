...
// without touching ~/.joopo/joopo.json.
const getRuntimeConfigMock = vi.fn();
const mutateConfigFileMock = vi.fn();

vi.mock("joopo/plugin-sdk/runtime-config-snapshot", () => ({
  getRuntimeConfig: () => getRuntimeConfigMock(),
}));
vi.mock("joopo/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("joopo/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("joopo/plugin-sdk/config-mutation");
  vi.resetModules();
});
