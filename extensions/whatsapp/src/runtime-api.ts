export { getChatChannelMeta, type ChannelPlugin } from "joopo/plugin-sdk/core";
...
export { normalizeE164 } from "joopo/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "joopo/plugin-sdk/config-types";
import type { JoopoConfig as RuntimeJoopoConfig } from "joopo/plugin-sdk/config-types";

export { type ChannelMessageActionName } from "joopo/plugin-sdk/channel-contract";
...
export type JoopoConfig = RuntimeJoopoConfig;
