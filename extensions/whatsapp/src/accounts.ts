...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "joopo/plugin-sdk/config-types";
import { resolveOAuthDir } from "joopo/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: JoopoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: JoopoConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: JoopoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: JoopoConfig): ResolvedWhatsAppAccount[] {
