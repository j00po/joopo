...
} from "joopo/plugin-sdk/agent-harness";
import { createTokenjuiceJoopoEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: JoopoAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<JoopoAgentToolResult> | void> | Partial<JoopoAgentToolResult> | void;
