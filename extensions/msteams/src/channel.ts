import { describeAccountSnapshot } from "joopo/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "joopo/plugin-sdk/allow-from";
import { createTopLevelChannelConfigAdapter } from "joopo/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "joopo/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "joopo/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "joopo/plugin-sdk/channel-message";
import { createPairingPrefixStripper } from "joopo/plugin-sdk/channel-pairing";
import {
...
} from "joopo/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "joopo/plugin-sdk/interactive-runtime";
import { createLazyRuntimeNamedExport } from "joopo/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "joopo/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "joopo/plugin-sdk/status-helpers";
...
const resolveMSTeamsChannelConfig = (cfg: JoopoConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: JoopoConfig }>(
