...
function resolveJoopoVersion(): string {
  try {
 ...
 * and appends the Joopo version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Joopo/<joopo-version>"
 * Example: "teams.ts[apps]/2.0.5 Joopo/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Joopo/${resolveJoopoVersion()}`;
  return cachedUserAgent;
}
