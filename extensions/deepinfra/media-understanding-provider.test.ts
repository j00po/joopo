...
vi.mock("joopo/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/media-understanding")>(
    "joopo/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("joopo/plugin-sdk/media-understanding");
  vi.resetModules();
});
