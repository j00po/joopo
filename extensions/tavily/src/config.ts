...
export function resolveTavilySearchConfig(cfg?: JoopoConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: JoopoConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: JoopoConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
