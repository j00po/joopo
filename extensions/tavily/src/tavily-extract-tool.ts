...
import type { JoopoPluginToolContext } from "joopo/plugin-sdk/plugin-entry";
...
export function createTavilyExtractTool(api: JoopoPluginApi, ctx?: TavilyToolConfigContext) {
  return {
    name: "tavily_extract",
