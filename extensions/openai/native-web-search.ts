...
import { streamWithPayloadPatch } from "joopo/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: JoopoConfig | undefined): boolean {
