...
import type { ProviderPlugin } from "joopo/plugin-sdk/provider-test-contracts";
...
vi.mock("joopo/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("joopo/plugin-sdk/provider-catalog-runtime")
  >("joopo/plugin-sdk/provider-catalog-runtime");
