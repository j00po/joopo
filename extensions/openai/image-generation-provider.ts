...
} from "joopo/plugin-sdk/image-generation";
import {
  parseOpenAiCompatibleImageResponse,
  toImageDataUrl,
} from "joopo/plugin-sdk/image-generation";
import { createSubsystemLogger } from "joopo/plugin-sdk/logging-core";
import { resolveClosestSize } from "joopo/plugin-sdk/media-generation-runtime";
import { extensionForMime } from "joopo/plugin-sdk/media-mime";
import {
...
import { resolveApiKeyForProvider } from "joopo/plugin-sdk/provider-auth-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.JOOPO_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: JoopoConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: JoopoConfig | undefined): boolean {
