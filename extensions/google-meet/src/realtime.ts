...
} from "joopo/plugin-sdk/realtime-transcription";
import {
...
import {
  consultJoopoAgentForGoogleMeet,
...
export function buildGoogleMeetSpeakExactUserMessage(text: string): string {
  return [
    "Speak this exact Joopo answer to the meeting, without adding, removing, or rephrasing words.",
