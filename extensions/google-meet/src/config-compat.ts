...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.google-meet.config.realtime.provider="google" is legacy for Gemini Live bidi mode; use realtime.voiceProvider="google" and realtime.transcriptionProvider="openai". Run "joopo doctor --fix".',
    match: hasLegacyGoogleRealtimeProvider,
  },
];

export function migrateGoogleMeetLegacyRealtimeProvider(config: JoopoConfig): {
  config: JoopoConfig;
  changes: string[];
} | null {
