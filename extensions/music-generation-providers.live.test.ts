...
const providerFilter = parseCsvFilter(process.env.JOOPO_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.JOOPO_LIVE_MUSIC_GENERATION_MODELS);
