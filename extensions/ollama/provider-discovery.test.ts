...
import type { ModelDefinitionConfig } from "joopo/plugin-sdk/provider-onboard";
import { withFetchPreconnect } from "joopo/plugin-sdk/test-env";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "joopo-test-"));
  ...
  async function runOllamaCatalog(params: { config?: JoopoConfig; env?: NodeJS.ProcessEnv }) {
