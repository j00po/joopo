...
import { buildApiKeyCredential } from "joopo/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: JoopoPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: JoopoConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "joopo configure". ' +
        "See: https://docs.joopo.ai/providers/ollama",
    });
  },
});
