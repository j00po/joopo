...
import { resolveEnvApiKey } from "joopo/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: JoopoConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: JoopoConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: JoopoConfig): string {
