...
Nostr DM channel plugin for Joopo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Joopo. It enables your bot to:
...
# Configure joopo to use local relay
