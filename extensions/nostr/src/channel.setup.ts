...
import { patchTopLevelChannelConfigSection } from "joopo/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: JoopoConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: JoopoConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: JoopoConfig): string {
