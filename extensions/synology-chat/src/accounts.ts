...
import { resolveDangerousNameMatchingEnabled } from "joopo/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Joopo config object. */
function getChannelConfig(cfg: JoopoConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: JoopoConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.JOOPO_BOT_NAME ?? "Joopo";
