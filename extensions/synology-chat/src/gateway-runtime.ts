import { DEFAULT_ACCOUNT_ID, type JoopoConfig } from "joopo/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "joopo/plugin-sdk/webhook-ingress";
