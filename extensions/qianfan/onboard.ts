...
function resolveQianfanPreset(cfg: JoopoConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: JoopoConfig): JoopoConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: JoopoConfig): JoopoConfig {
