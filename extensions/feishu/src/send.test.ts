...
vi.mock("joopo/plugin-sdk/markdown-table-runtime", () => ({
  resolveMarkdownTableMode: mockResolveMarkdownTableMode,
}));

vi.mock("joopo/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("joopo/plugin-sdk/text-runtime")>();
  return {
    ...actual,
...
describe("getMessageFeishu", () => {
  ...
  afterAll(() => {
    vi.doUnmock("joopo/plugin-sdk/markdown-table-runtime");
