import type * as ConversationRuntime from "joopo/plugin-sdk/conversation-runtime";
...
async function dispatchMessage(params: { cfg: JoopobotConfig; event: FeishuMessageEvent }) {
...
describe("createFeishuMessageReceiveHandler media dedupe", () => {
  it("keeps same-id media variants distinct at receive time", async () => {
    ...
    const handler = createFeishuMessageReceiveHandler({
      cfg: { channels: { feishu: { dmPolicy: "open" } } } as JoopobotConfig,
      core,
