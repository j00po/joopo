...
import { asFiniteNumber, asObject, trimToUndefined } from "joopo/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: JoopoConfig | undefined): string | undefined {
