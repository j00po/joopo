...
// Deprecated compatibility surface for existing @joopo/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "joopo/plugin-sdk/runtime-group-policy";
