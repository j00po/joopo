...
import { loadJsonFile, saveJsonFile } from "joopo/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "joopo/plugin-sdk/routing";
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("joopo.discordThreadBindingsState");
