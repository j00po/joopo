...
import * as pluginCommandsModule from "joopo/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "joopo/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: JoopoConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: JoopoConfig) => void;
