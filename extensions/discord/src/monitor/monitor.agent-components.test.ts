...
import { peekSystemEvents, resetSystemEventsForTest } from "joopo/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): JoopoConfig => ({}) as JoopoConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`joopo pairing approve discord ${code}`);
