import type { ChannelRuntimeSurface } from "joopo/plugin-sdk/channel-contract";
import {
  listNativeCommandSpecsForConfig,
  listSkillCommandsForAgents,
} from "joopo/plugin-sdk/command-auth";
import type { JoopoConfig, ReplyToMode } from "joopo/plugin-sdk/config-types";
import { createConnectedChannelStatusPatch } from "joopo/plugin-sdk/gateway-runtime";
import {
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "joopo/plugin-sdk/native-command-config-runtime";
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "joopo/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "joopo/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "joopo/plugin-sdk/runtime-env";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("joopo/plugin-sdk/reply-history").HistoryEntry[]
    >();
