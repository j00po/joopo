...
import { resolveNativeCommandSessionTargets } from "joopo/plugin-sdk/command-auth-native";
import type { JoopoConfig } from "joopo/plugin-sdk/config-types";
import { buildPairingReply } from "joopo/plugin-sdk/conversation-runtime";
import { isDangerousNameMatchingEnabled } from "joopo/plugin-sdk/dangerous-name-runtime";
import { getAgentScopedMediaLocalRoots } from "joopo/plugin-sdk/media-runtime";
import {
...
} from "joopo/plugin-sdk/native-command-registry";
import { resolveChunkMode, resolveTextChunkLimit } from "joopo/plugin-sdk/reply-chunking";
import { createSubsystemLogger, logVerbose } from "joopo/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "joopo/plugin-sdk/runtime-group-policy";
...
function resolveDiscordCommandOwnerAllowFrom(cfg: JoopoConfig): string[] | undefined {
