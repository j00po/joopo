...
import type { NativeCommandSpec } from "joopo/plugin-sdk/command-auth";
import { resolveDirectStatusReplyForSession } from "joopo/plugin-sdk/command-status-runtime";
...
import { dispatchReplyWithDispatcher } from "joopo/plugin-sdk/reply-dispatch-runtime";
...
async function createNativeCommand(cfg: JoopoConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: JoopoConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(() => {
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("joopo/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("joopo/plugin-sdk/plugin-runtime").executePluginCommand,
    );
