...
import { danger, warn, type RuntimeEnv } from "joopo/plugin-sdk/runtime-env";
import { normalizeLowercaseStringOrEmpty } from "joopo/plugin-sdk/text-runtime";

export type GetPluginCommandSpecs =
  typeof import("joopo/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("joopo/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("joopo/plugin-sdk/plugin-runtime");
