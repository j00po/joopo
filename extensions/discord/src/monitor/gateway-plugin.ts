...
import { danger } from "joopo/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("joopo/plugin-sdk/config-types").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class JoopoGatewayPlugin extends discordGateway.GatewayPlugin {
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Joopo registers its own async interaction listener.
