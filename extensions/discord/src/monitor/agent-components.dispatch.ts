...
import { createNonExitingRuntime, logVerbose } from "joopo/plugin-sdk/runtime-env";
import { logError } from "joopo/plugin-sdk/text-runtime";
...
let replyPipelineRuntimePromise:
  | Promise<typeof import("joopo/plugin-sdk/channel-message")>
  | undefined;
...
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("joopo/plugin-sdk/channel-message");
