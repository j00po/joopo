...
let listNativeCommandSpecs: typeof import("joopo/plugin-sdk/command-auth").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    cfg?: JoopoConfig;
    discordConfig?: NonNullable<JoopoConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: JoopoConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<JoopoConfig["channels"]>["discord"] =
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("joopo/plugin-sdk/command-auth"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<JoopoConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<JoopoConfig["channels"]>["discord"];
