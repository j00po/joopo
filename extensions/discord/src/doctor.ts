...
import { collectProviderDangerousNameMatchingScopes } from "joopo/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: JoopoConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: JoopoConfig,
  doctorFixCommand: string,
): { config: JoopoConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: JoopoConfig): string[] {
