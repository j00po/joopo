import type { DirectoryConfigParams } from "joopo/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "joopo/plugin-sdk/messaging-targets";
