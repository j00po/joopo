...
import { buildOutboundMediaLoadOptions } from "joopo/plugin-sdk/media-runtime";
import { extensionForMime } from "joopo/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "joopo/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "joopo/plugin-sdk/reply-payload";
import type { RetryRunner } from "joopo/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: JoopoConfig },
): Promise<{ channelId: string; dm?: boolean }> {
