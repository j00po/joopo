...
vi.mock("joopo/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/routing")>(
    "joopo/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("joopo/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/agent-runtime")>(
    "joopo/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
