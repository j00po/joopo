...
import type { JoopoConfig, TtsConfig } from "joopo/plugin-sdk/config-types";
import { parseTtsDirectives } from "joopo/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: JoopoConfig; override?: TtsConfig }): {
  cfg: JoopoConfig;
