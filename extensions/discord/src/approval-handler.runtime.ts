...
import type { ExecApprovalActionDescriptor } from "joopo/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalDecision } from "joopo/plugin-sdk/approval-runtime";
import type { DiscordExecApprovalConfig, JoopoConfig } from "joopo/plugin-sdk/config-types";
import { logDebug, logError, normalizeOptionalString } from "joopo/plugin-sdk/text-runtime";
