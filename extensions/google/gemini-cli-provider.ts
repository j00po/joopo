...
import { buildOauthProviderAuthResult } from "joopo/plugin-sdk/provider-auth-result";
...
import { fetchGeminiUsage } from "joopo/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: JoopoPluginApi) {
