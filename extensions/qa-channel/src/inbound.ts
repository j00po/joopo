import { dispatchChannelMessageReplyWithBase } from "joopo/plugin-sdk/channel-message";
...
export async function handleQaInbound(params: {
  ...
  const route = runtime.channel.routing.resolveAgentRoute({
    cfg: params.config as JoopoConfig,
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as JoopoConfig),
    body: inbound.text,
  });
