...
export function resolveSearxngCategories(config?: JoopoConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: JoopoConfig): string | undefined {
