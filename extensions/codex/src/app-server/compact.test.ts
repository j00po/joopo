...
import type { HarnessContextEngine as ContextEngine } from "joopo/plugin-sdk/agent-harness-runtime";
...
describe("maybeCompactCodexAppServerSession", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "joopo-codex-compact-"));
  });
