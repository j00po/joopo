/**
 * Twitch channel plugin for Joopo.
 *
...
} from "joopo/plugin-sdk/channel-pairing";
 ...
 * for Joopo. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: JoopoConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: JoopoConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: JoopoConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: JoopoConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("joopo/plugin-sdk/runtime-env").RuntimeEnv;
