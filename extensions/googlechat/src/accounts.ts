...
import { safeParseJsonWithSchema, safeParseWithSchema } from "joopo/plugin-sdk/extension-shared";
import { isSecretRef } from "joopo/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: JoopoConfig): ResolvedGoogleChatAccount[] {
