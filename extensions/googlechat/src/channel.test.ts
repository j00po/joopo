...
function resolveGoogleChatAccountImpl(params: { cfg: JoopoConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: JoopoConfig) => {
...
function createGoogleChatCfg(): JoopoConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
