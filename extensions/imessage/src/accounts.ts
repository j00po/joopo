...
function mergeIMessageAccountConfig(cfg: JoopoConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: JoopoConfig): ResolvedIMessageAccount[] {
