...
import { resolveHumanDelayConfig } from "joopo/plugin-sdk/agent-runtime";
import { logTypingFailure } from "joopo/plugin-sdk/channel-feedback";
import {
...
import { createChannelPairingChallengeIssuer } from "joopo/plugin-sdk/channel-pairing";
import {
  readChannelAllowFromStore,
  upsertChannelPairingRequest,
} from "joopo/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "joopo/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "joopo/plugin-sdk/host-runtime";
import { runInboundReplyTurn } from "joopo/plugin-sdk/inbound-reply-dispatch";
import { isInboundPathAllowed, kindFromMime } from "joopo/plugin-sdk/media-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "joopo/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "joopo/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "joopo/plugin-sdk/reply-runtime";
import { createReplyDispatcherWithTyping } from "joopo/plugin-sdk/reply-runtime";
import { settleReplyDispatcher } from "joopo/plugin-sdk/reply-runtime";
import { getRuntimeConfig } from "joopo/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "joopo/plugin-sdk/runtime-env";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "joopo/plugin-sdk/runtime-group-policy";
import { resolvePinnedMainDmOwnerFromAllowlist } from "joopo/plugin-sdk/security-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "joopo/plugin-sdk/session-store-runtime";
import { truncateUtf16Safe } from "joopo/plugin-sdk/text-runtime";
import { waitForTransportReady } from "joopo/plugin-sdk/transport-ready-runtime";
 ...
 *   exec ssh -T joopo@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., joopo@192.168.64.3)
