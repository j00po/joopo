...
import { stringEnum } from "joopo/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, JoopoPluginApi, JoopoPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: JoopoPluginToolContext | undefined,
