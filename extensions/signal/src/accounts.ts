...
function mergeSignalAccountConfig(cfg: JoopoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: JoopoConfig): ResolvedSignalAccount[] {
