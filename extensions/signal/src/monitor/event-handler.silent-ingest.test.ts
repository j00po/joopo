...
vi.mock("joopo/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("joopo/plugin-sdk/hook-runtime")>(
    "joopo/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
