...
const GENERATED_START = "<!-- joopo:wiki:generated:start -->";
const GENERATED_END = "<!-- joopo:wiki:generated:end -->";
const HUMAN_START = "<!-- joopo:human:start -->";
const HUMAN_END = "<!-- joopo:human:end -->";
