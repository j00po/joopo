...
import { mapPluginConfigIssues } from "joopo/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type JoopoPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: JoopoPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".joopo", "wiki", "main");
}
