...
import { resolveDefaultAgentId, resolveSessionAgentId } from "joopo/plugin-sdk/memory-host-core";
import type { MemorySearchResult } from "joopo/plugin-sdk/memory-host-files";
import { getActiveMemorySearchManager } from "joopo/plugin-sdk/memory-host-search";
import {
  extractTranscriptStemFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "joopo/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "joopo/plugin-sdk/session-visibility";
...
const AGENT_DIGEST_PATH = ".joopo-wiki/cache/agent-digest.json";
const CLAIMS_DIGEST_PATH = ".joopo-wiki/cache/claims.jsonl";
const RELATED_BLOCK_PATTERN =
  /<!-- joopo:wiki:related:start -->[\s\S]*?<!-- joopo:wiki:related:end -->/g;
