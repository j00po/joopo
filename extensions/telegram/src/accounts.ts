...
import {
  ...
  type JoopoConfig,
} from "joopo/plugin-sdk/account-core";
import type { TelegramAccountConfig, TelegramActionConfig } from "joopo/plugin-sdk/config-types";
import { formatSetExplicitDefaultInstruction } from "joopo/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "joopo/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.JOOPO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: JoopoConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: JoopoConfig): string {
...
export function listEnabledTelegramAccounts(cfg: JoopoConfig): ResolvedTelegramAccount[] {
