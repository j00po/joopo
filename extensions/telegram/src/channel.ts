...
import type { ChannelMessageActionAdapter } from "joopo/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "joopo/plugin-sdk/channel-lifecycle";
...
} from "joopo/plugin-sdk/outbound-send-deps";
import { type RoutePeer } from "joopo/plugin-sdk/routing";
import {
...
const telegramMessageAdapter = createChannelMessageAdapterFromOutbound<JoopoConfig>({
  id: "telegram",
  live: {
    capabilities: {
      draftPreview: true,
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as JoopoConfig;
