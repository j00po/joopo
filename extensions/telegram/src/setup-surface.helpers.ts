...
export function shouldShowTelegramDmAccessWarning(cfg: JoopoConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`joopo config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`joopo config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
