...
import { isAbortRequestText } from "joopo/plugin-sdk/command-primitives-runtime";
import type {
  JoopoConfig,
  ReplyToMode,
...
import { chunkMarkdownTextWithMode } from "joopo/plugin-sdk/reply-chunking";
...
async function resolveStickerVisionSupport(cfg: JoopoConfig, agentId: string) {
  try {
