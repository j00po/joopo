import { resolveAccountWithDefaultFallback } from "joopo/plugin-sdk/account-core";
...
import { coerceSecretRef } from "joopo/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: JoopoConfig; value: unknown }): {
  token: string;
