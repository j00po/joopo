...
vi.mock("joopo/plugin-sdk/media-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("joopo/plugin-sdk/media-runtime")>();
  return {
    ...actual,
...
vi.mock("joopo/plugin-sdk/hook-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("joopo/plugin-sdk/hook-runtime")>();
  return {
    ...actual,
    triggerInternalHook,
  };
...
vi.mock("joopo/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("joopo/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
