import { resolveNormalizedAccountEntry } from "joopo/plugin-sdk/account-core";
import type { BaseTokenResolution } from "joopo/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "joopo/plugin-sdk/channel-core";
import type { JoopoConfig } from "joopo/plugin-sdk/config-types";
import type { TelegramAccountConfig } from "joopo/plugin-sdk/config-types";
import { resolveDefaultSecretProviderAlias } from "joopo/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "joopo/plugin-sdk/routing";
import {
...
export function resolveTelegramToken(
  ...
  // See: https://github.com/joopo/joopo/issues/53876
