...
import { isTruthyEnvValue, isWSL2Sync } from "joopo/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "joopo/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "JOOPO_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "JOOPO_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "JOOPO_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable JOOPO_TELEGRAM_DNS_RESULT_ORDER
