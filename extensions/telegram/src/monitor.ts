...
import { resolveAgentMaxConcurrent } from "joopo/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: JoopoConfig): RunOptions<unknown> {
  return {
    sink: {
