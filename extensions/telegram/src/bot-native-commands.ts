...
import { resolveChannelStreamingBlockEnabled } from "joopo/plugin-sdk/channel-streaming";
import {
  resolveCommandAuthorizedFromAuthorizers,
  resolveNativeCommandSessionTargets,
} from "joopo/plugin-sdk/command-auth-native";
import {
...
import type { ChannelGroupPolicy } from "joopo/plugin-sdk/config-types";
import type {
  ReplyToMode,
...
import { resolveMarkdownTableMode } from "joopo/plugin-sdk/markdown-table-runtime";
...
import { getRuntimeConfigSnapshot } from "joopo/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "joopo/plugin-sdk/runtime-env";
...
type TelegramChunkMode = ReturnType<
  typeof import("joopo/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("joopo/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): JoopoConfig => telegramDeps.getRuntimeConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: JoopoConfig): TelegramAccountConfig => {
    try {
