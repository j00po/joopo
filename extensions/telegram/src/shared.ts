...
import { createChannelPluginBase, type ChannelPlugin } from "joopo/plugin-sdk/channel-core";
import { getChatChannelMeta } from "joopo/plugin-sdk/channel-plugin-common";
 ...
 */
function isBlockedByMultiBotGuard(cfg: JoopoConfig, accountId: string): boolean {
