import { resolveApprovalApprovers } from "joopo/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "joopo/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "joopo/plugin-sdk/approval-runtime";
import type { JoopoConfig } from "joopo/plugin-sdk/config-types";
import type { TelegramExecApprovalConfig } from "joopo/plugin-sdk/config-types";
import type { ReplyPayload } from "joopo/plugin-sdk/reply-runtime";
import { normalizeAccountId } from "joopo/plugin-sdk/routing";
import {
...
function resolveTelegramOwnerApprovers(cfg: JoopoConfig): Array<string | number> {
