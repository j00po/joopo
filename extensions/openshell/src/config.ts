...
import { buildPluginConfigSchema, type JoopoPluginConfigSchema } from "joopo/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): JoopoPluginConfigSchema {
