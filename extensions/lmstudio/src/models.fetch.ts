...
import { SELF_HOSTED_DEFAULT_COST } from "joopo/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "joopo/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to Joopo model definitions. */
