...
function readLegacyGrokFallbackAuth(cfg?: JoopoConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: JoopoConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: JoopoConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: JoopoConfig): string | undefined {
