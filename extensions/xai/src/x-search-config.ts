...
function resolveLegacyXSearchConfig(config?: JoopoConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: JoopoConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: JoopoConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: JoopoConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: JoopoConfig): JsonRecord | undefined {
