...
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "joopo/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "joopo/plugin-sdk/provider-stream-shared";
import { jsonResult, readProviderEnvValue } from "joopo/plugin-sdk/provider-web-search";
    ...
    execute: async (toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!tool) {
        return jsonResult({
          ...
          docs: "https://docs.joopo.ai/tools/code-execution",
        });
      }
