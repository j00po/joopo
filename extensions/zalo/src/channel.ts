import { describeWebhookAccountSnapshot } from "joopo/plugin-sdk/account-helpers";
...
import type { ChannelAccountSnapshot } from "joopo/plugin-sdk/channel-contract";
import {
...
import { buildTokenChannelStatusSummary } from "joopo/plugin-sdk/channel-status";
import type { JoopoConfig } from "joopo/plugin-sdk/config-types";
import { createStaticReplyToModeResolver } from "joopo/plugin-sdk/conversation-runtime";
import { createChannelDirectoryAdapter } from "joopo/plugin-sdk/directory-runtime";
import { listResolvedDirectoryUserEntriesFromAllowFrom } from "joopo/plugin-sdk/directory-runtime";
...
import { chunkTextForOutbound } from "joopo/plugin-sdk/text-chunking";
import {
  listZaloAccountIds,
