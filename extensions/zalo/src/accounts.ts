...
function mergeZaloAccountConfig(cfg: JoopoConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: JoopoConfig): ResolvedZaloAccount[] {
