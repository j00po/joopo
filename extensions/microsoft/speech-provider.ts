...
import { isVoiceCompatibleAudio } from "joopo/plugin-sdk/media-runtime";
import { assertOkOrThrowProviderError } from "joopo/plugin-sdk/provider-http";
import {
  captureHttpExchange,
...
import type {
  ...
  SpeechVoiceOption,
} from "joopo/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "joopo/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
