...
function mergeZalouserAccountConfig(cfg: JoopoConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: JoopoConfig; accountId?: string | null }) {
