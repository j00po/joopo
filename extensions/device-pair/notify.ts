...
import type { JoopoPluginService } from "joopo/plugin-sdk/core";
import { listDevicePairing } from "joopo/plugin-sdk/device-bootstrap";
...
export function createPairingNotifierService(api: JoopoPluginApi): JoopoPluginService {
...
export function registerPairingNotifierService(api: JoopoPluginApi): void {
