import { resolveClaudeThinkingProfile } from "joopo/plugin-sdk/provider-model-shared";
import type { ModelProviderConfig } from "joopo/plugin-sdk/provider-model-types";
import {
