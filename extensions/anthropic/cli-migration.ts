...
type AgentDefaultsModel = NonNullable<NonNullable<JoopoConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<JoopoConfig["agents"]>["defaults"]>["models"];
type AgentDefaultsRuntimePolicy = NonNullable<
  NonNullable<JoopoConfig["agents"]>["defaults"]
>["agentRuntime"];
