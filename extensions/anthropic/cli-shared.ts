...
// steer Joopo-managed Claude CLI runs toward a different provider,
...
function isJoopoRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isJoopoRequestedYolo(context)
