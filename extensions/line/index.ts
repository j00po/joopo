import {
  ...
  type JoopoPluginCommandDefinition,
  type JoopoPluginApi,
} from "joopo/plugin-sdk/channel-entry-contract";

type RegisteredLineCardCommand = JoopoPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: JoopoPluginApi): Promise<RegisteredLineCardCommand> {
