...
vi.mock("joopo/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("joopo/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("joopo/plugin-sdk/plugin-config-runtime");
    vi.doUnmock("./accounts.js");
    vi.doUnmock("./channel-access-token.js");
    vi.doUnmock("joopo/plugin-sdk/channel-activity-runtime");
