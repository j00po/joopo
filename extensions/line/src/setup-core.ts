import type { ChannelSetupAdapter, JoopoConfig } from "joopo/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "joopo/plugin-sdk/setup";
...
export function isLineConfigured(cfg: JoopoConfig, accountId: string): boolean {
