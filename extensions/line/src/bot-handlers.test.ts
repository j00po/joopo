...
vi.mock("joopo/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("joopo/plugin-sdk/channel-pairing", () => ({
...
vi.mock("joopo/plugin-sdk/command-auth", () => ({
...
vi.mock("joopo/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("joopo/plugin-sdk/group-access", () => ({
...
vi.mock("joopo/plugin-sdk/reply-history", () => ({
...
vi.mock("joopo/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("joopo/plugin-sdk/channel-inbound");
    vi.doUnmock("joopo/plugin-sdk/channel-pairing");
    vi.doUnmock("joopo/plugin-sdk/command-auth");
    vi.doUnmock("joopo/plugin-sdk/runtime-group-policy");
    vi.doUnmock("joopo/plugin-sdk/runtime-env");
    vi.doUnmock("joopo/plugin-sdk/group-access");
    vi.doUnmock("joopo/plugin-sdk/reply-history");
    vi.doUnmock("joopo/plugin-sdk/routing");
    vi.doUnmock("joopo/plugin-sdk/conversation-runtime");
