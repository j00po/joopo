import { buildChannelConfigSchema } from "joopo/plugin-sdk/channel-config-primitives";
import {
  AllowFromListSchema,
  ...
  ToolPolicySchema,
} from "joopo/plugin-sdk/channel-config-schema";
import { buildSecretInputSchema } from "joopo/plugin-sdk/secret-input";
