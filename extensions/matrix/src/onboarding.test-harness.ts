import type { OutputRuntimeEnv } from "joopo/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "joopo/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Joopo Gateway",
    },
    confirm: {
