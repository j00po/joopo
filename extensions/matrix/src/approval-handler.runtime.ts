...
import { buildPluginApprovalResolvedReplyPayload } from "joopo/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// Joopo Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.joopo.approval" as const;
