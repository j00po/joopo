...
import { hasConfiguredSecretInput } from "joopo/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: JoopoConfig): Record<string, unknown> | null {
