...
import { resolveControlCommandGate } from "joopo/plugin-sdk/command-gating";
import {
  evaluateSupplementalContextVisibility,
  resolveChannelContextVisibilityMode,
} from "joopo/plugin-sdk/context-visibility-runtime";
import { hasFinalInboundReplyDispatch } from "joopo/plugin-sdk/inbound-reply-dispatch";
import type { GetReplyOptions } from "joopo/plugin-sdk/reply-runtime";
...
import { normalizeOptionalString } from "joopo/plugin-sdk/string-coerce-runtime";
import type {
  CoreConfig,
  MatrixConfig,
  MatrixRoomConfig,
...
import { MATRIX_JOOPO_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("joopo/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("joopo/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("joopo/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("joopo/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("joopo/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("joopo/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_JOOPO_FINALIZED_PREVIEW_KEY]: true };
}
