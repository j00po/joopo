import { resolveConfiguredAcpBindingRecord } from "joopo/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "joopo/plugin-sdk/session-binding-runtime";
