...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/joopo-matrix-create-client-test",
    storagePath: "/tmp/joopo-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/joopo-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/joopo-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/joopo-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "joopo-matrix-default-token-hash",
