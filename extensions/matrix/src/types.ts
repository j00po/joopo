...
export type MatrixStreamingConfig = {
  ...
  progress?: import("joopo/plugin-sdk/channel-streaming").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<JoopoConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: JoopoConfig["secrets"];
  [key: string]: unknown;
};
