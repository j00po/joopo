...
- JOOPO_IOS_VERSION = exact canonical iOS version
- JOOPO_MARKETING_VERSION = short iOS/App Store version
- JOOPO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
JOOPO_IOS_VERSION = ${IOS_VERSION}
JOOPO_MARKETING_VERSION = ${MARKETING_VERSION}
JOOPO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
