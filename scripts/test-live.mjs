...
const env = {
  ...process.env,
  JOOPO_LIVE_TEST: process.env.JOOPO_LIVE_TEST || "1",
  JOOPO_LIVE_TEST_QUIET: quietOverride ?? process.env.JOOPO_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.JOOPO_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
