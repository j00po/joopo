...
- Keep product names in English: Joopo, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Joopo Gateway, use “Gateway 网关”.
