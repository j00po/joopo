...
const (
	...
	envDocsI18nProvider      = "JOOPO_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "JOOPO_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<joopo_docs_i18n_input>", "</joopo_docs_i18n_input>"} {
