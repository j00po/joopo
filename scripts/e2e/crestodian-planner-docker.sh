...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-crestodian-planner-e2e" JOOPO_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="joopo-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t joopo-crestodian-planner-log.XXXXXX)"
...
JOOPO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
