...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-commitments-safety-e2e" JOOPO_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="joopo-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t joopo-commitments-safety-log.XXXXXX)"
