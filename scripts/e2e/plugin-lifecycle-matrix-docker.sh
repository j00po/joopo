...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-plugin-lifecycle-matrix-e2e" JOOPO_PLUGIN_LIFECYCLE_MATRIX_E2E_IMAGE)"
SKIP_BUILD="${JOOPO_PLUGIN_LIFECYCLE_MATRIX_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz plugin-lifecycle-matrix "${JOOPO_CURRENT_PACKAGE_TGZ:-}")"
...
JOOPO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 plugin-lifecycle-matrix empty)"
