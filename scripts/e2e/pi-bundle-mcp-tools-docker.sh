...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-pi-bundle-mcp-tools-e2e" JOOPO_IMAGE)"
CONTAINER_NAME="joopo-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t joopo-pi-bundle-mcp-tools-log.XXXXXX)"
...
JOOPO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 pi-bundle-mcp-tools empty)"
