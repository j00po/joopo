...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-session-runtime-context-e2e" JOOPO_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="joopo-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t joopo-session-runtime-context-log.XXXXXX)"
