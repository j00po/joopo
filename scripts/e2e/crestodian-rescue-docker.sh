...
IMAGE_NAME="$(docker_e2e_resolve_image "joopo-crestodian-rescue-e2e" JOOPO_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="joopo-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t joopo-crestodian-rescue-log.XXXXXX)"
...
JOOPO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
