...
const pluginRecordSnapshot = () => {
  const config = readJson(joopoPath("joopo.json"));
...
function seedInstallState() {
  writeJson(joopoPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.JOOPO_CONFIG_PATH, { plugins: {} });
  writeJson(joopoPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Joopo plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Joopo will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  for (const expected of [
    ...
    `Run joopo plugins inspect ${pluginId} --runtime --json for details.`,
  ]) {
