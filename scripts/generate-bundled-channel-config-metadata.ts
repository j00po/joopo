...
function resolvePackageChannelMeta(source: BundledPluginSource) {
  const joopoMeta =
    ...
    "joopo" in source.packageJson
      ? (source.packageJson.joopo as Record<string, unknown> | undefined)
      : undefined;
  const channelMeta =
    joopoMeta &&
    typeof joopoMeta.channel === "object" &&
    joopoMeta.channel &&
    !Array.isArray(joopoMeta.channel)
      ? (joopoMeta.channel as Record<string, unknown>)
      : undefined;
  return channelMeta;
}
