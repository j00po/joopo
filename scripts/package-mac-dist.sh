...
# Output:
# - dist/Joopo.app
# - dist/Joopo-<version>.zip
# - dist/Joopo-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.joopo.mac}"
...
ZIP="$ROOT_DIR/dist/Joopo-$VERSION.zip"
DMG="$ROOT_DIR/dist/Joopo-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Joopo-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Joopo-$VERSION.dSYM.zip"
