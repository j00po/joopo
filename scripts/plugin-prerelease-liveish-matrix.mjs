const LIVEISH_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    env: ["TELEGRAM_BOT_TOKEN", "JOOPO_TELEGRAM_BOT_TOKEN"],
  },
  {
    probe: "channel-discord",
    env: ["DISCORD_TOKEN", "JOOPO_DISCORD_TOKEN"],
  },
  {
    probe: "channel-slack",
    env: ["SLACK_BOT_TOKEN", "JOOPO_SLACK_BOT_TOKEN"],
  },
  {
    probe: "channel-whatsapp",
    env: ["WHATSAPP_ACCESS_TOKEN", "JOOPO_WHATSAPP_ACCESS_TOKEN"],
  },
]);
