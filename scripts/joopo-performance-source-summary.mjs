...
function printHelp() {
  console.log(`Usage: node scripts/joopo-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes Joopo-native performance probe artifacts for CI reports.`);
}
