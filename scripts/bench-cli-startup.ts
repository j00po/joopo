...
function printUsage(): void {
  console.log(`Joopo CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: joopo.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "joopo-cli-bench-"));
