...
import {
  ...
  type JoopoTestState,
  type JoopoTestStateOptions,
} from "../../src/test-utils/joopo-test-state.js";
import { sleep } from "../../src/utils.js";

export type JoopoTestInstanceOptions = {
  name: string;
  cwd?: string;
  port?: number;
  gatewayToken?: string;
  ...
  state?: Omit<JoopoTestStateOptions, "applyEnv" | "gateway" | "env">;
  gatewayArgs?: string[];
  startTimeoutMs?: number;
  stopTimeoutMs?: number;
};

export type JoopoTestInstanceCommandResult = {
  code: number | null;
...
export type JoopoTestInstance = {
  ...
  ) => Promise<JoopoTestInstanceCommandResult>;
...
export async function createJoopoTestInstance(
  options: JoopoTestInstanceOptions,
): Promise<JoopoTestInstance> {
  ...
  const instance: JoopoTestInstance = {
    name: options.name,
    port,
