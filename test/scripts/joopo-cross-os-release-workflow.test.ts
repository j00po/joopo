...
const WORKFLOW_PATH = ".github/workflows/joopo-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-joopo-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-joopo-cross-os-release-checks.sh";
