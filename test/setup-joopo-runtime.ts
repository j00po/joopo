...
const WORKER_RUNTIME_STATE = Symbol.for("joopo.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("joopo.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("joopo.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: JoopoConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
