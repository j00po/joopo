...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.joopo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Joopo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__joopo__/a2ui/").absoluteString + "?platform=macos"
    }
