...
final class TalkMLXSpeechSynthesizer {
    ...
    private let logger = Logger(subsystem: "ai.joopo", category: "talk.mlx")
    ...
    func synthesize(
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("joopo-mlx-tts-\(token.uuidString)", isDirectory: true)
    ...
    private static func helperInvocation() -> HelperInvocation {
        ...
        if let override = ProcessInfo.processInfo.environment["JOOPO_MLX_TTS_BIN"], !override.isEmpty {
        ...
        if let executableDir = Bundle.main.executableURL?.deletingLastPathComponent() {
            let bundled = executableDir.appendingPathComponent("joopo-mlx-tts")
        ...
        return HelperInvocation(
            ...
            argumentPrefix: ["joopo-mlx-tts"],
            displayName: "joopo-mlx-tts")
    }
