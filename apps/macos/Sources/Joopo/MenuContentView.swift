...
/// Menu contents for the Joopo menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Joopo") { self.open(tab: .about) }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .joopoSelectSettingsTab, object: tab)
        }
    }
