...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/joopo/joopo") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/joopo/joopo")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://joopo.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "JoopoBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JoopoBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "JoopoGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "JoopoGitCommit") as? String) ??
            "unknown"
    }
