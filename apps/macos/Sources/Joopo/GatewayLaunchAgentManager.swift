...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.joopo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".joopo/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.joopoCommand(
            subcommand: "gateway",
