...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .joopoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? JoopoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? JoopoPaths.stateDirURL.path
...
extension Notification.Name {
    static let joopoSelectSettingsTab = Notification.Name("joopoSelectSettingsTab")
}
