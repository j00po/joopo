...
enum JoopoConfigFile {
    private static let logger = Logger(subsystem: "ai.joopo", category: "config")
    ...
    static func url() -> URL {
        JoopoPaths.configURL
    }

    static func stateDirURL() -> URL {
        JoopoPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        JoopoPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-joopo-config-file",
            "event": "config.write",
