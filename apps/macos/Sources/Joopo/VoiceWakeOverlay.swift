...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.joopo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Joopo windows, but below the system’s pop-up menus.
