...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.joopo", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        JoopoPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        JoopoPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
