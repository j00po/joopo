...
enum UIStrings {
    static let welcomeTitle = "Welcome to Joopo"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "joopo.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: JoopoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g joopo@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: JoopoChatViewModel(
