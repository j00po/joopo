...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.joopo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.joopo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [JoopoChatMessage] = messages.compactMap { item in
