...
private let onboardingWizardLogger = Logger(subsystem: "ai.joopo", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between JoopoProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = JoopoProtocol.AnyCodable
