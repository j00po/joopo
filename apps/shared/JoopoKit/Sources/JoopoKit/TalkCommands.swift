...
public enum JoopoTalkCommand: String, Codable, Sendable {
...
public struct JoopoTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct JoopoTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
