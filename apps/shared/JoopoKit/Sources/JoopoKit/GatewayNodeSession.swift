...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.joopo", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.joopo", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: JoopoProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
