...
public enum JoopoCanvasA2UICommand: String, Codable, Sendable {
...
public struct JoopoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct JoopoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
