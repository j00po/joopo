...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: JoopoProtocol.AnyCodable]?
    {
        ...
        return [
            "id": JoopoProtocol.AnyCodable(identity.deviceId),
            "publicKey": JoopoProtocol.AnyCodable(publicKey),
            "signature": JoopoProtocol.AnyCodable(signature),
            "signedAt": JoopoProtocol.AnyCodable(signedAtMs),
            "nonce": JoopoProtocol.AnyCodable(nonce),
        ]
    }
}
