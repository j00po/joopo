...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "joopo devices approve req-123",
            docsURLString: "https://docs.joopo.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "joopo devices approve req-123")
        #expect(error.docsURLString == "https://docs.joopo.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "joopo devices approve req-123")
    }
