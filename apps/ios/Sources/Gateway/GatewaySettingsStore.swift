...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.joopo.gateway"
    private static let nodeService = "ai.joopo.node"
    private static let talkService = "ai.joopo.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.joopo.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.joopo.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("joopo-gateway.log")
    }
