...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.joopo.ios", category: "LiveActivity")
    private var currentActivity: Activity<JoopoActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = JoopoActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<JoopoActivityAttributes>.activities
    ...
    private func updateCurrent(state: JoopoActivityAttributes.ContentState) {
    ...
    private func connectingState() -> JoopoActivityAttributes.ContentState {
        JoopoActivityAttributes.ContentState(
    ...
    private func idleState() -> JoopoActivityAttributes.ContentState {
        JoopoActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> JoopoActivityAttributes.ContentState {
        JoopoActivityAttributes.ContentState(
