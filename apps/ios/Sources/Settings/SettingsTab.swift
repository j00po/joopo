...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = JoopoLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = JoopoLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.joopo.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Joopo agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Joopo agent.")
                        { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Joopo. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(JoopoLocationMode.off.rawValue)
                            Text("While Using").tag(JoopoLocationMode.whileUsing.rawValue)
                            Text("Always").tag(JoopoLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Joopo is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Joopo", value: DeviceInfoHelper.joopoVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = JoopoLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Joopo chat and run /pair approve, then tap Connect again."
        }
