...
Maintenance update for the current Joopo development release.
...
Maintenance update for the current Joopo release.

## 2026.4.19 - 2026-04-19

Maintenance update for the current Joopo beta release.
...
First App Store release of Joopo for iPhone. Pair with your Joopo Gateway to use chat, voice, sharing, and device actions from iOS.
