...
import ai.joopo.app.NotificationBurstLimiter
import ai.joopo.app.SecurePrefs
import ai.joopo.app.allowsPackage
import ai.joopo.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("joopo.secure", Context.MODE_PRIVATE)
