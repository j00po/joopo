...
import ai.joopo.app.VoiceCaptureMode
import ai.joopo.app.voice.VoiceConversationEntry
import ai.joopo.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Joopo is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
