...
import ai.joopo.app.ui.mobileAccentBorderStrong
...
import ai.joopo.app.ui.mobileHeadline
import ai.joopo.app.ui.mobileSurface
import ai.joopo.app.ui.mobileText
import ai.joopo.app.ui.mobileTextSecondary
import ai.joopo.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.joopo.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.joopo.app.ui.mobileFontFamily,
