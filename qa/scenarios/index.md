...
- use `pnpm joopo qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Joopo QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Joopo repo from source + docs before acting.
