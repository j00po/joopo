...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as JOOPO_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                JOOPO_OAUTH_DIR: path.join(stateDir, "credentials"),
                JOOPO_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
