...
execution:
  ...
  config:
    firstPrompt: "@joopo Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@joopo Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
